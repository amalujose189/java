 ...
 * @author OWNER
 */
public class maximumof3 extends javax.swing.JFrame {

    /**
     * Creates new form maximumof3
     */
    public maximumof3() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(n1>n2)
        {
            if(n1>n3)
            {
                l1.setText(n1+"is greator");
            }
            else
            {
                l1.setText(n3+"is greator");
            }
        }
        else
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(maximumof3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new maximumof3().setVisible(true);
            }
        });
    }
